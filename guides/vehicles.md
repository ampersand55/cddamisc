...
Just install a foot crank on the wheelbarrow. As of the current build you can steer it even if the light wheel mount isn't steerable. 
...
- None
#### Components
- 8 long strings OR 8 long cordage pieces OR 8 long leather laces OR 48 short strings OR 48 short cordage pieces OR 48 short leather laces OR thread (2400) OR sinew (2400) OR plant fiber (2400) OR yarn (2400) OR heavy duty thread (2400) OR Nomex thread (4800) OR Kevlar thread (4800)
- chunk of steel (4)
- 1 stick OR 1 plank
